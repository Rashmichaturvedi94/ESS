    ...
    <CourseDetailSubscribeComponent>
      <Box  style={{marginLeft: 50, marginTop: 50}}>
        ...
        <Box style={{ marginLeft: 40, marginRight: 110}}>
          <img src="https://blog.wildix.com/wp-content/uploads/2020/06/react-logo.jpg" style={{ height: 450, width: 600, overflow: 'hidden'}} alt={course.data?.title}/>
      ...
      <Box>
        ...
        <Box display="flex" style={{marginLeft: 100, marginTop: 90, backgroundColor: '#C4C4C4' }}>
          <ButtonText
             fullWidth
              variant="text"
              onClick={() =>
        ...
        <Box display="flex" style={{marginLeft: 100, marginTop: 30, backgroundColor: '#C4C4C4' }}> 
          <ButtonText
            fullWidth
            variant="text"
          >
