  ...
  return (
    <LoginComponent>
      <Box flex={1} display="flex" alignItems="center" justifyContent="center"> 
        <Box style={{backgroundColor:'#C4C4C4'}} justifyContent="center" width="45%" height="100%">
          <ImportContactsIcon style={{ color: 'black', fontSize: 150, marginTop: 50, marginLeft: 300}} />
