  ...
  return (
    <GridList>
      {courses.data?.map((course) => (
        <GridListTile key={course.id} style={{ height: 258, width: 224, border: '2px solid black', margin: 8}} onClick={() => history.push(generatePath(appPaths.subscribeCourse, { courseId: course.id }))}>
